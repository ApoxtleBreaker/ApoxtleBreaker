...
//点击导航栏显示扩展顶部
document.getElementById('header').addEventListener(touchOrClick, scrollToTop);
function scrollToTop() {
    ...
    //显示后删除监听导航栏的动画
    document.getElementById('header').removeEventListener(touchOrClick, scrollToTop);
}
...
document.getElementById('top').addEventListener(touchOrClick, hideTop);
//M键复位
